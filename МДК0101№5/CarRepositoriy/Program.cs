...
repository.Insert(new Car { Id = 2, Make = "Chevrolet", Model = "Camaro", Year = 2017, Color = "White" });
repository.Insert(new Car { Id = 3, Make = "Nissan", Model = "350Z", Year = 2016, Color = "Black" });
